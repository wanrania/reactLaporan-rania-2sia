  ...
  "
    >
      ...
      <div className="flex items-center gap-3">
        <SidebarTrigger className="h-10 w-10 rounded-xl border border-slate-200 bg-white shadow-sm hover:bg-slate-50" />
        ...
        <div className="relative group cursor-pointer ml-1">
          ...
          >
            <ul className="text-sm text-slate-700 py-1">
              <li className="px-4 py-2.5 hover:bg-slate-50 font-medium cursor-pointer transition-colors">
                Profil Saya
              </li>
              <li className="px-4 py-2.5 hover:bg-slate-50 font-medium cursor-pointer transition-colors">
                Pengaturan
              ...
              <li
                ...
                className="px-4 py-2.5 hover:bg-red-50 text-red-600 font-bold cursor-pointer"
              >
                Keluar Aplikasi
              </li>
            </ul>
            ...
            <div className="mt-6 text-sm">
              ...
              <ul className="space-y-1.5">
                <li className="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer text-slate-700 font-medium transition-colors">
                  <FaSearch className="text-slate-400 text-xs" /> Servis Honda
                  Beat
                </li>
                <li className="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer text-slate-700 font-medium transition-colors">
